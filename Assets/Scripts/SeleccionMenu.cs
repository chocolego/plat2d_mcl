...
public class SeleccionMenu : MonoBehaviour
{
    ...
    // {
    //     // No hay opciones disponibles, no hay nada que hacer
    //     return;
    // }
    ...
    //     posicion = opciones.Length - 1;
    // } 
    // else if (posicion >= opciones.Length)
    // {
    //     posicion = 0;
    // }
    
    // // Asegúrate de que posición esté dentro de los límites del arreglo
    // posicion = Mathf.Clamp(posicion, 0, opciones.Length - 1);
